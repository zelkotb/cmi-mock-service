...
public class DebtController {
	...
	public DebtsResponseDTO getDebts(@RequestParam String typeCanal, @RequestParam String aquereurID,
			...
			@RequestParam String dateServeur, @RequestParam(required = false) String categorieCreance,
		...
		return this.debtService.getDebts(typeCanal, aquereurID, modeID, canalID, creancierID, dateServeur,
				categorieCreance, refTxSysPmt, realMAC.replace(" ", "+"));
	}
}
