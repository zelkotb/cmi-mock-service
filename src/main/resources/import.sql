...
insert into form_field (field_name, field_type, field_format, min_size, max_size, contrainte) values ('Numéro de ligne à recharger','text','entier',4,15,1);
...
insert into form_field (field_name, field_type, field_format, min_size, max_size, contrainte) values ('Numéro de téléphone Mobile','text','entier',4,15,1);
...
insert into form_field (field_name, field_type, field_format, min_size, max_size, contrainte) values ('Numéro de Ligne','text','entier',4,15,1);
...
insert into debt_canal (debt, canal) values (11,'1'),(11,'2'),(11,'3');
